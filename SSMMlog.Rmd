...
1. Alter critique -- Jim 
2. Update IMR estimates via Dempap; via BRA; via alternate ages
3. For our conclusion -- implications for USA fertility story 
4. Remove section on proof of concept? Goal: <1 page of text plus a modelled SR from West life-table?
5. Narrow down the CEA paper -- Northern US & Canada? NE North America?

Other papers to write:
A "note" to challenge and expunge the 19th C IMR estimates presented in HSUS. 
Via 
Reid & Jaadish -- issue of ECM in relation to IMR
