...
2022.1210 Js & Ji suggest that leaving mothers alone, with "masters" choices much worse for infant mortality and producing kids; are there generalizations to pursue? Issue of "discounting" the future -- master's future profit? Issue of parent's discounting their kids' future less than an owner would?  (LeGuinn angle?)

2022.1016  Sandberg & Steckel 1987 AnnHuBio and claim of mild subsistence crisis in Sweden in mid19C  ... something for us?

2022 Ji wanted to follow up on South Africa data sources; and guy in Africa re:SRB?
...
2022.1209 cross-census tracking (1850 to 1860) suggest sex-biased age-heaping at 5, 10, 15, etc. The u5m cohort appears to grow 4% while the u5f declines 3% -- plausibly 1850's u5m cohort is missing 4-year-olds coded as age 5, while 1860's 10to14m includes some 9-year-olds. There are too many free parameters to make many strong inferences, but consider the simple issue of the CSR in 1850 in light of the 1860 data.
For each 1850 CSR value, what is the 1860 proxy value?
u5 +2.3%  10to14 -4.7%  
u10 +1.4% 10to19 -0.9%
u19 +0.6% 10to29 -0.3%  
u29 -0.1% 10to29 -0.0%    BUT: 1860s 10-year-olds may well be biased via treatment of 9-yr-olds.   I suspect 15-24 more accurately measured than 10-19 -- 


 OOPS -- raises concern that our result is an artifact of age-heaping of boys into age 5 (relative to girls).     


Example: 0-4 to 10-14  m +4%  f -3%   but 5-9 to 15-19 m -8% f -5% pool ages and much less: u10 to 10-19 m -2%  vs f -4%          
So for sex-ratios, if use 1860 5to9 as proxy for 1850 u5, SR shifts 7% toward boys, but if us 1860s 10to19 to proxy for 1850 u10, SR shifts just 2.3% toward boys (still unhealthy value)

2022.1207 cumbersome code for Alter-like cross-census tracking (can't get summarize_all or across to work, so end up writing every silly var name {sm14=sum(sm14,na.rm=T),sf14=sum(sf14, ... )}        
And after all that 1850 to 1860 survivals suggest fairly extreme age-heaping with some sex-bias ... more work needed (how much is just getting code wrong?)

2022.12 used 1870 and 1900 census manuscripts to identify people age u5 in 1860; can't find any examples of 1860 u5 persons  not enumerated with their 1860 household; rather fairly frequent rounding up of ages (despite June 1 1860 census day, person with DOB July 1 1859 is enum as 1 and not as 11 months ); 0 to 1, 4 to 5 etc. CLAIM: oft-cited "underenumeration" of infants is simply mis-enumeration, counting them as 1; similarly u5 is too small but u6 includes all u5 ... to pursue for HSUS and "22.1024 loose end" that said:      
 
        2022.1024 family trees probably give accurate birth years, so use them to characterize 1860 census manuscripts enumeration of infants and young children. Ji's conjecture is that 11-mos olds are rounded up to one-year, and that 4.5 year olds are rounded up to 5yr olds. How does lower mortality of 4.5 yr olds vs infants affect undercount sorts of issues?




2022.1123 glitchy tiny populations of slaves with indeterminate SLH sizes ...e.g. Hancock VA 2 slaves ... no SLH returns for MS Washington, Sunflower, Hancock. 

2022.1122   Ji grabbed 1860 LA sugar data: 23 counties with non-negligible sugar; but their total u5 pop is maybe 25k -- too small to feature ...

* Jim to look at "black" SRB -- to what extent does a female-tilted CSR reflect "black" SRB    ... 5th Senegal/Chicago  2024-25 PostDoc
* 1860 US census ICPSR: county-level women in mfg L 


2022.1121  
slv/pop > 40% 2.62m  2/3 of US slaves, CSR +3.2% ; <40% 1.31  +1.7%
plantations 2.635 CSR +3.47%  nonplantation 1.25%    1860   -- look at same counties in 1850, if the slave populations are large enough? (large enough that plantations are plausible -- vs newly settled?)

2022.1119 Ji finds 1850 & 1860 county-level census data. First step is confirm u5 slave populations      
Wonder about church/religion data in cenvols -- of interest?  what about f labor in manuf?


2022.1108 Ji will turn from LIT to empirical work ...

2022.1028   rural/urb IMR -- Js uses 1890 Woods et al ... 

2022.1026 Ji bogged down in English demography during start of JEH proofing

2022.1024 sorting out census data for US slavery and post ... 1870 Hacker finds is worst undercount of native white, esp in South.

2022.1021 1880 published volume includes chinese & indian in colored. Probably 1870 and 1900 can show us which states have large pops of chinese or indian ... 1870 u5 chinese US  Calif 331 185+146  "civilized indians" US 3154 1636+1518      4CO 816  22NV 754  7GA 231   16KS 136    33NC  146    44WA 123    46WI 162                  

2022.1019 need to sketch out empirical content of slvpap --
could include 1830, 1840 data for u10 pop ...  

use ICPSR & 1850

2022.1016  Ji decides to return to logging. 5 hours burnt digging into Steckels birth-weight from Lumi. No birthweight data for the Bundi ...    
Ji notices Sandberg & Steckel 1987 AnnHuBio and claim of mild subsistence crisis in Sweden in mid19C  ... something for us?

2022 from september     
alive RDS files : 1910 DS1910.RDS is u5g u5b & u1d   -- 19 solo with 100k kids;  * could add small PA cities for 1905 to fill in missing PA 1905 value      
u5CEAtots.RDS regions of US, and US, decenially 1840-1950    

[dempap link](https://jrmcirwin.github.io/sr1/DemPap_1.pdf) 

<!-- ## To do for submission Js: England quinquennial 1926-1971 (not 1925-1970); drop NLD 1869;  -->


2022.0907 emma Griffin's book Breadwinner looks promising -- re;henry George progress breeds poverty; also IMR in Engl ...

2022.0827 Jim sees MinnStP not included -- leave for now or fix? If fix MN urban will be "all" and not "white" ---  just need to use NYC/Brooklyn sort of code to get MnStP together

2022.0826 we were using google docs to track our work and try to finish HSUS. Looking ahead -- might be worth breaking out Suffolk Co from Mass totals?

2022.0808 Ji trying to clarify VS data available to corroborate/challenge 

2022.0730 
Ji sees 1921-28 IMR as roughly OK/credible; but the entries to BRA have a little higher IMR.  1921 65% included (in 1930 VS, 1921's missing states have IMR 8% above non-missing).        1927 88%  1928 94%  1933 100% (Tx added) IMR 52.8 and w/o Tx 52.3  
1920 BRA white IMR was 82   -- just the 1915 BRA states together had 1920 IMR of 90 -- the apparent decline is from 99 to 82 but it would be just within the 1915BRA ... 

2022.0725 Ji notices JPE paper^[https://www-journals-uchicago-edu.cmich.idm.oclc.org/doi/10.1086/717455#sc5] with structure of a lengthy "Introduction" of 15 paragraphs summarizing the paper, then data, results, and conclusion of 1 paragraph. 

2022.0724 Ji starts to check older IMR data, b/c 1910 disparages birth counts ... 1910 MI compared to MA suggests MI births undercounted such that true IMR is 100 vs measure 125?

2022.0720 Ji finds 1910 IMR for reg states and some cities.  1910 fpUms?   But indications the births data are bad (but MI births good starting in 1906, says MI). Overall, some confusion about which data are sound ... 

2022.0717  1890 reg states  CT DE DC MA NH NJ NY RI VT

1890 VS white IMR
NJ white total 115   urban 136  rural 82      ... 
NY white total 104   urban 125  rural 60    ...   1900   143  urb 163  rur 95
NYC white IMR 1880 LT 220 ;  1890 VS 137  ; 1900 VS 168  
p596 Table 1, VS,

2022.0714

 4Life-table estimates are known to be poor for infant mortality -- cites!
 Fig 3 -- expand Y axis (IMR 0 to 300 )

2022.0713    close of day, Ji got sidelined with 1880/1900 IMR u5dr comparisons for MA and NJ  ... punchline: in MA & NJ, the 1880 and 1900 IMRs were likely similar. Worsening IMR comes from urbanization elsewhere?

Mass 1855?        R&R guys on IMR - Kerala -- seems to be Riley, citing Caldwell

The SR1 is determined by two, additively separable terms -- "determined" or "reflects"

2022.0712  NJ 1880 enumeration of deaths by age groups (compared to registration record):

2022.0711 clarify 1940 pop values --

2022.0710  Ji searches for statements of consensus on IMR -- answer is, there is almost no attention to US IMR; instead vague statements about mortality transition (often saying transition from last 1/4 of 19C -- probably inconsisent with Fogel etc heights&e10 )

2022.0708 
check on South Africa data via Cornell guy paper ...
 To confirm: we've got 1901 & 1910 DC, IN, MA, MI, NJ, NY, and Bost, Chic, NYC, Phil from 1910 census life tables
Mass SR:IMR  now uses cenVol and not fPUMS.  1890 was in error in U5.rds
1870 avg is 0.004 more fem; 1880 avg is .001 more fem; 1900 is .002 less fem;

2022.0706 moved discussion rural/urb u1dr:SR (conclusion was to stick to state aggregates, due to apparent urban-birthing).     
1900 rural/urb u1dr:SR may prove problematic: I (Ji) predict rural SRs will suggest higher IMRs than are suggested  by  rural u1dr (due to urban-birthing). More generally, likely we cannot distinguish between two sources of low u1dr in rural data: low IMR and urban-birthing. So high u1dr in rural areas circa 1900 would be interesting (strong evidence of high IMR); but low rural u1dr uniformative. And for both rural and urban, variation in urban-birthing is likely to mess with the observed  u1dr:SR relationship. Urban u1dr will tend to look high relative to the urban SR; rural u1dr will tend to look low relative to the rural SR.  For example, MA in 1930, urban/rural values: u1dr 95/33, SR -3.1/-3.3, IMR  66/67  Here SR:u1dr relationship is driven by urban-birthing (I suspect).  So for me, we are left with one-sided signals of IMR – high rural u1dr signals high IMR; low urban u1dr signals low IMR.    
1880 u1dr values are quite high, as expected (mostly between 170 & 260 ); fun question is how they compare to 1900!!! answer: we only have city data for 1900; and the 1900 u1dr values for cities are generally much LOWER than those for 1880. That said, US urbanization goes from 30% to 40%, and with an urban penalty, a declining urban IMR easily could leave 1900 IMR above 1880 IMR … 



2022.0705   1920 im:sr looks ready ...

2022.0703  status as Ji leaves for Peterborough.     
SRimr1900.RDS has single-year SR:IMR pairs ready for plotting (aggregation/geog consistency is done)     
IMR_SRgrouped1930.RDS has 5-year avg IMR:SR pairs ready for plotting (aggregated/geo-consistency is done)
imsr20.RDS needs to be culled/aggregated for IMR:SR plotting; it includes both state aggregates and the urban rural splits thereof; it also has urban totals and some of the cities that are in those urban totals. (imsr30.RDS has same for 1930).     
Possible next steps: 1920's IMR_SRgrouped; 1900's primary (disaggregated data). Jim could do in Peterborough



Note: for RDS for SR:IMR, realized we need two stages. One the data, ungrouped; then with flags for aggregations.    

2022.0702  1900 imr:sr check NYCxBM, MIrur, Cinc+Clev -- all confirm (but note variation of SR for given IMR)

2022.0630 1900 imr:sr check a few obs for validity of code (check for outliers? or does that bias?)

2022.0629 1910 census has life tables -- cannot discern reliable births data there; they seem to infer births from annual pop by age and lexus triangles. 

2022.0628 fixed the ERROR in CITIES file -- age 5 included in some ???

2022.0627 about finished with T19 data entry; next R code to create imr:sr data set; probably choose aggregations like Cleve+Cincci+Toldeo ?   Might have work to do on CITIES for u1d:SR?


working with 1900 census Mort Stats in T19 ... note that white IMR rural 107  urb 162   
For now, focus on reg states urb/rur splits and Reg Cities for IMR:SR (so don't do cities separately except for big ones). NH is reg state, so use urb/rur and don't separately enter cities of NH. 


2022.0625 u1sStatesW.R creates StatesU1dr-U5pop.RDS  -- 1880 to 1930 state-level u1dr & u5 pops.

2022.0624 
Question: how do we want to use the u1d data?
61AZ u1dr is 117 while predicted (on IMR) would be about 131  -- reflecting relatively low Births per K U5 pop for AZ is 179 (no simple/easy explanation found from quick look at 1920 to 1930 populations of AZ). Not a magnitude to delay us further. PUNCHLINE: state-level u1dr is a good proxy for IMR

2022.0623  u1drIMR by state works very well -- 2 not on the line: 
1930 62 COLORADO had erroneous u1d (huge numbers!)
1930 31Nevada -- messed up by small "colored" pop with huge IMR relative to u1dr. Can simply use whites 1926-1929 to avoid issue of how "Mexicans" enumerated in 1930

 1900-1950 India: SR05 increasingly masculine CSR  ... SR0-14 about stable ... 10-14   ROBUSTNESS: u2 ... 

via online IPUMS, demonstrate that MA rural has very few births relative to u5 population and relative to potential mothers (age 15-40); leading to silly-low rural u1dr relative to IMR. To fix, need to aggregate

interesting twist for using u1dr (u1 deaths per U5 pop) as proxy for IMR -- Tuscon & Phoenix had very high u1dr for their IMR because of non-residents in urban institutions ( births and u1deaths ); that point stated in Mortality Statistics volume. Oddly low u1dr of Mass rural probably a similar issue (converse? thereof).  Mass rural has expected population structure (e.g. u5 relative to wome

00071 from IPUMS has 1930 (for u1dr vs IMR issue)

2022.0622 anomalously low u1dr for MA and 2 others -- I suspect a problem with urb/rur defs in PUMS vs VS -- maybe just do exBoston?  what of other NewEng? 

2022.0621   1920 for IMR:u1dr comparisons ... IMu1d.RDS

re: India 1881-1931 except Travancore, high IM according to actuaries, and not much relationship seen between IMR and SRs as there observed -- issue to pursue: SR data suggests 1) more geographic variation in IMR and 2) urban penalty suggested by Dyson? might be wrong; maybe SR data will point to rural IM awful in colonial India?

2022.0620 Ji review 1920-30 for urb/urb106 (e.g. Chic)
 1930 NYC Chi Phil Detroit LA Cleve StLouis Balt Boston Pittsb <Minn 464K StP 272 = 736> 
 1930 SanFran 630k Mil 578 (47K kids in 1930)  Buff 573 (48k kids in 1930)

2022.0617     

1920: often we have 5 years of u1d but fewer years of IMR (because births not counted yet). We want to know if u1 death rates track IMR. Ji uses the 5year u1dr and the avgIMR ...

Thinking 1930 census white/mexican/colored issue means we avoid AZ -- what of NV NM CA ?  When PUMS U5s loaded, have a look ...

1930 u5fW from cenVol 65NV 2940, 66NM 19828, 61AZ 12000, 71CA 158355 

    
Ji lays aside 1940 census volume data for HSUS -- first will do PUMS version, then go and add cenVol white:urb/rur Metros.

2022.0614 Ji trying to wrap up 1910. Find that 2021December attempt at eIMR from 1909&1910 avg u1 deaths used   
eIMR=1000* (1/ (u1/w1U1dec+1.66) )   but I now think the last term should be (u1/w1U1dec + 0.66), where 0.66 is (1-0.34) and 0.34 is the separation factor (see Preston et al. 2000:47 for 1/q = (1/m + 1-a )

Thinking of general approach -- we seek to characterize mortality regime using infant deaths in relation to the u5 population that survived, or the u2 population that survived. Generally, we could take a single year of deaths as an estimate of the annual average for the period in question. Thinking we should use the appropriate set of deaths when available, and be satisfied with rougher estimates when that is all we have.   
The year 1910 offers us rural/urban splits -- should we use those splits with state-level u1d rates? 




2022.0608
JIM: SR5DRA.RDS Data needed for HSUS body union of 1870-1930 datasets with any two of SR, IMR, 5yrDr, 1yrDR.   IMR & 5yDR & 1YrDR -- do the death rates track IM?  For appendix, 1890 cross-section of 5yrDR:SR used to extrapolate from Mass.  Then hand off to Jesse to crunch results.

Jesse: Indian states 1971-1981 SR:IMR    1911 SR5 & SR    ; UN --  ... 

Dreadful childhood -- Ji catch up on the lit  
...
2022.0531 Ji leans to adding a line with Black IMR projection via DemPap regression lines (and maybe look at how the white SouAfr SR:IMR value looks in our regression?)

2022.0528 Ji inclined to leave exploration of India to DemPap-Grande
 Travancore-Cochin 1951 differs somewhat from Kerela 1971, because 1951 it includes the 5 Tamil taluks that shift to Tamil Nadu; and because Kerela 1971 has Malabar (big) and Kasaragod taluk of South Canara district. 

2022.0527 For India  1911 to 1971 we don't have consistent boundaries -- so be careful of how we extraploate on 1911 SR for IMR, don't overstate the geographic similarities ... also, avoid extrapolating on 1 IMR point? maybe Sou Afr approach is suspect? 
    found India 1971 census age/sex   -- entered Kerala, but let's add Brerar? and some urbans  -- don't want our SR story always to be same (6% swing implies ...)  


2022.0526 wondering how to use  u1deaths data of 1910, 1900, 1890, 1880 ... 
 1900 census Vol III vouches for registrations in Mass, CT, RI, NH ...

2022.0523    REGION 22  urb10 too small mostly.  34MO ok 56k   

2022.0522 noticed MD urb10 was set to use=0  -- a mistake, I believe.

2022.0516  
1930 11 DE 5k, 52 MD 29k       43 FL 35k  
1930   63 ID 21k, 64 MT 19k,  68 WY 9k /  65 NV 3k, 66 NM 22k, 67 UT 20k

2022.0515 
imBRA has building blocks for cea prediction, need to combine with sr5, after packing
BigCities  1920 NY Chi Philly   1930 bigCities add  Detroit u5w > 140K   
leaving LosAngeles out for now (78+15=93K), because no racial breakdown; can add via use race=all (VS & pums are fine, it is cenVol problem)
not  Cleveland u5w < 65K not StLouis u5white = 52k   -- longer term aggregate for midW-city group.

LA 78K but 17 "other races"   -- recall Mexican classed as nonwhite -- for first pass, drop 
CA  AZ   

2022.0514 # RDS/u5CEAtots.RDS has US/urb-rur/4regions fPUMS 1850-80, 1900-40; cenVol 1940-50, and some earlier.
 
 OH 1920 Cleveland u5 88433 black 2371 or 3%   -- but mort is not avail by race ... so drop from u5cea: for 1920 OH we'll have rur10 and urb10 --  will need to knock out urb10 for state-year where we have urb106?


for CEA get a prediction equatiom BRA data (1930, 1920: metro/urb106/rur10)

2022.0513  fPUMS does not split Brooklyn out from New York NY  -- probably could do it via publlished census ... POSTCEA

2022.0512   use fPUMS for splitting up states (might get those breakdowns, with effort, from published census volumes)
Use URBPOP<100 (100 00 is 10K and URBPOP seems best at including unincorporated NewEngland towns of size -- no difference for VT, ME, NH, CT; same effect for NJ & PA, NY no diff (PA urb10 764.3 vs 760.7; NJ 364.35 vs 360.9)



2022.0509 

Ji works on References formatting ...

submission notes
[DR says](https://www.demographic-research.org/info/guidelines.htm#References) For exact details on how to compile your reference list, please see our Reference Guidelines. It is not necessary to format your reference list before the work is submitted, but once your submission is accepted we will request that you reorganize the list so that it conforms to our standards.

post-submission issues -- do we want to refer to Registrar General as author ...



2022.0508 (Ji to CLovelly) Js to try to wrap up dempap (in morning chat Ji reviews 507 tweaks)

2022.0501   LT parag ?   -- maybe ENgland's historic ones?     Js should write chapter: Goldilocks and the 3 sex ratios    
English LTs    
LT1 SRB 105.2       SR1exact 101.99 SR5exact 101.55     IMR 

1896 LT06 SRBrg  103.7   SR1exact 100.2  SR5exact  99.5     IMR 146  
1911 LT08 SRBcen 103.9   SR1exact 101.2  SR5exact 100.9     IMR 112.5      
1921 LT09 SRBcen 105.07  SR1exact 102.75 SR5exact 102.4     IMR  79.9     
1931 LT10 SRBrg  104.88  SR1exact 103.0  SR5exact 102.6      IMR  63.4 
1951 LT11 SRB
1961 LT12

2022.0430  concern with title saying "indicator" of IMR -- reveal was more accurate ..  Using Childhood S R to characterize IMR 

2022.0422 need to settle on intro (Jim wants point that IMR is much lower now than historically, with our method a hist tool ... )  

2022.0421 leads for Paris 1950s data

Atlas des Parisiens : de la Révolution à nos jours : population, territoire et habitat, productions et services, religion, culture, loisirs
columbia clio Structures demographiques et premieres estimations de la population de Paris a l'horizon 1974
[Population par commune de 1851 à 1968](https://catalog.hathitrust.org/Search/Home?lookfor=%22%20France%20Population%20Statistics.%22&type=subject&inst=#:~:text=Population%20par%20commune%20de%201851%20%C3%A0%201968)

2022.0418 Ji about done with intro section; finishing up expansion of "not structural" discussion -- now it is too long; need to find balance (but clear simple statments here make model more useful and make results easier to interpret later)

Ji wants to block out the interp of results ... 


Eventual set of regs for robustness:   direct: CSR on IMR; reverse: IMR on CSR  -- how predict IMR? via reverse, or solve out direct? 
also CSR on IMR with slope-dummy when IMR gets to a level where Drevenst shows MU has fallen to 0.17; CSR on IMR 2 slope dummies -- IMR low & high (viz mu values)
also CSR on IMR IMR2
also CSR on IMR and dummy variables based on SRB values ...



2022.0416  play around with examples of u1pop and either u1d or B to estimate IMR  -- separation factors are more influential for IMR(B,P) then IMR(D,P)  -- intuitively sensible, since D/B is the magnitude of interest and it is <<1, so loading uncertainty into the numerator rather than the denominator, generates more uncertainty.  


wonder if Somalia's u5 mortality rates by sex are consistent with SR data?

2022.0415 notice South Africa yearbook 1980-81 they "estimate" black IMR to be 100-110; values are given for Whites 21.6 Coloureds 132.6 and Asians 36.4    -- do we have CSR?

2022.0414  Demography's top journal dismissed our work; instead of sending to the least prestigous Demography journal, why not send to a high-quality econ outlet like AER or JPE?

send to Hill ?  Kenneth Hill is a demographer who specializes in deriving estimates of mortality from incomplete or deficient data.  He has a Ph.D. from the London School of Hygiene and Tropical Medicine, and has spent most of his career at the Johns Hopkins Bloomberg School of Public Health and the Harvard School of Public Health. Kenneth_hill_1@yahoo.com

noted CSR offers powerful test of M-I misery -- to reject a null hypothesis of wellness in favor of alternative of misery. But CSR is not a powerful test of M-I wellness, can't reject null of misery without evidence that there is not mortal miscogyny. 


2022.0413  Jim identifies 12 valid CSR values for Sweden 1757-1855, to add to current 1860 onward .... 
Jim to hand off structure abs soon?

2022.0412 current null H is submit to DR -- open access; truth will out; disparge status games;
JIH -- would need a more densely historical approach.  SSH?  JEH?

2022.0411 

concerned that maybe DemRes has low-quality articles, tidying up tidbits of knowledge. What about Pop Studies or Pop Dev Rev ?
Ask Rodrigo who reads what ?
...
The journal contains: Articles on advances in theory and application, policy analysis, sociographic studies, and critical assessments of recent research  Notes and commentaries on current population questions and policy developments  Data and perspectives on new statistics and their interpretation




french IMR from French HMD & see Bonnet DemRes paper.  

found site for ENglish data: [A Vision of Britain through Time](http://www.visionofbritain.org.uk/unit/10076845/cube/AGESEX_85UP) which has London census data 1861, 1881-2011 ... also births and infant deaths, for IMR calc ...

2022.0410  Looking at census of eng & w 1871 --  pdf 92 has toc for tables; maybe no urban nor countydetail
 dead-ends in terms of determining role of still-birth definitions for NETH/Eng differences.  But do find Neth provincial data for SR and IMR ... how to use?    Census source puts m u1 deaths as just 119.3% of f u1d; and with SRB toward male, MU even less than 19%  -- not as I expected, having reasoned that sb were being loaded into u1d and that the excess male IM would reflect that in a size of 130% or so ...  

2022.0409 
MOONEY  Still-births and the measurement of urban infant mortality rates c. 1890-1930.

sb leads to pursue [Woods 2005 fetal mortality Eng](https://www.jstor.org/stable/30040453?seq=1)
[Two hundred years of evidence‐based perinatal care: late‐fetal mortality in the past](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2672782/)    
[amsterdam](https://onlinelibrary.wiley.com/doi/full/10.1002/psp.2232)    
[woodsRo 2007](https://www.jstor.org/stable/44452158?seq=1)
[davisGayle SB registration scotland 1900-60](https://onlinelibrary.wiley.com/doi/full/10.1111/j.1468-0289.2009.00478.x)
[woodsRo fetal mortality](https://www.tandfonline.com/doi/abs/10.1080/00324720500099330)
[galley & woods](https://www.jstor.org/stable/2998689?seq=1)
book [nfant Mortality: A Continuing Social Problem](https://books.google.ca/books?id=YjqvrayLOZsC&lr=&source=gbs_navlinks_s)
 alice Reid 2001 pop studies;  Death, Grief and Poverty in Britain, 1870–1914 By Julie-Marie Strange;      
     lynch in Population and Economy: From Hunger to Modern Economic Growth
   AJPH [International infant mortality rates: bias from reporting differences.](https://ajph.aphapublications.org/doi/abs/10.2105/ajph.84.5.850)
   
minor: [Neth perinatal (current, for SRB) Regional perinatal mortality differences in the Netherlands; care is the question](https://bmcpublichealth.biomedcentral.com/articles/10.1186/1471-2458-9-102)

initial examples of healthy and unhealthy CSR:IMR  
healthy   Paris 1968

unhealthy


 defining IMR Barbieri 1998:  Les définitions légales de la naissance vivante et du décès fœtal tardif ainsi que les pratiques en matière de déclaration varient sensiblement d'un pays à l'autre, ce qui rend difficiles les comparaisons (Hohn, 1981 ; Masuy-Stroobant, 1996)

Masuy-Stroobant, Godelieve: Santé et mortalité infantile en Europe. Victoires d'hier et enjeux de demain  in  Santé et mortalité des enfants en Europe. Inégalités sociales d'hier et d'aujourd'hui"- p. 337-366 (ISBN : 978-2-87209-463-9) G. Masuy-Stroobant, C. Gourbin, P. Buekens 

Rollet & Bourdelais -- IMR in France 1750-1950
f58  false stillborn -- breathed before dying; 1907-10 false stillborns in catholic areas (baptism of liveborn only)

1880  1/5 of 40K SB false, rawIMR 150/900 = 166  corrected 190/940 202

to look over [WorldPop](https://www.worldpop.org/project/list)  ... 

direct vs reverse regression. Absent errors in IMR, which to use? direct (IMR on CSR) regression to predict IMR from CSR, or reverse? Prediction error variances, dir & rev, 
April 9  5.42 5.57
March trial 1 5.00 vs 5.33; trial 2: 4.88 vs 4.62;  
Modelled W = 5H - 100 + random error or W^=5H-100   implies H= 1/5 W + 20  sample n=50 R2 92%  W^ = 5.02H -98  and predictH = 1/5.02W +98/5.02    reverse reg gives  H^ = 0.184W + 22.3

2022.0405 data entry for 1890 complete; xls file has building blocks for SR5:IMR or SR5:u1d   --- endless task to idealize groupings. Hoping 40K is a large enough population; could drop smaller places, or
then RURAL:
RI 13.6 can be added to Mass 43.5  or to CT 39 or to LongIsl-ish 37.6   (adjacent to all; might share LongIsl maritime/close to city)
NH 20.9 can be added to Mass 43.5 or to VT 27.
NYG3 27.4 (just above NYC) can be added to CT 39 or to NYG5 113k (albany etc)
NYG2 28.5 (above Alb) can be added to VT 27 or NYGr5

add NH 21k & VT 27k ; either drop RI 13.6k or add to CT 39.2K or to LongIsle 37.6 ; NY gr3 is above NYC and has 27k -- it can be added to central NY's  113k  or to CT; NY group 2 is above Albany and pairs easilty with VT
2022.0404

for "cautious" use bigger minimum aggregates -- VT+NH  RI+CT  and NYGrp3+ (LongIsl etc) 


could look at NY rural total populations, in order to peel off tiny cities (<25K)  ...
ill want to leave California out of any serious 1890 estimation

2022.0403 finished entering the 1890 mortality data -- ended with 18 mostly large (100k) observations; but realize that the 1890 is standalone because of age-question anomoly. Thinking we should disaggregate, maybe have building blocks of (say) 10k to 30k and then think of how to assemble,  But we do want an *a priori* take on what size of population is enough to keep errors-in-variables manageable size ... ...

2022.0402 hope 1890 volumes give us rur/urb pop splits ...

2022.0401
  Jim to clarify -- from data on heights & weights --- to get a predictor of height from weight -- reg or reverse?
 modelled Weight = -100 + 5*Height + randomErrro



stumbled onto 1880 volume 11, 12 which have deaths data. v11 states 15-29; cities 499-56; v12 441-473 has cities & race     
v11 499-56 has groups of cities -- check if they are deemed reliable data; if so, use!    
...
Hist & Org of US VSS table 1.01 shows Iowa deaths reporting starts 
via US life tables : should be able to have 1901, 1910 for Boston NY  Chic   Phila   -  8 obs



looking at England, for life tables of 19th C (high IMR) to compare to 1921 or so (lower IMR) -- to show that it's been there for anyone who thought to look p23 excess male IMR 1841-1920
  75th annual report should have LT7  ... look for #8 1910-12 and #9 which is in Registrar-General's Decennial Supplement, England & Wales, 1921. Part 1. Life Tables.
     https://www.jstor.org/stable/41136791   says #7 is based on 1901-1911, so I want #6    
     “English Life Table No.6.” Journal of the Institute of Actuaries 43, no. 3 (1909): 351–62. doi:10.1017/S0020268100025002. refers to RegGen 65
 75th supp has LT 7 1901-1910
 Need part 1, not [Part II](http://www.histpop.org/ohpr/servlet/TOC?path=Browse/Registrar%20General%20(by%20date)/1891-1900&active=yes&mno=553&tocstate=expandnew&display=sections&display=tables&display=pagetitles) of Decenn suppl to reg-gen's 65th annual report
  
Ji suggests we consider an aggressive response to Demography – send out DemPap to 10 high-profile demographers, asking for their input in relation to Hayward’s suggestion that we need to explain why no one else came up with our idea of using CSRs as an indicator of maternal-infant misery and a proxy for IMR.




1921 reggen pdf755 has 1921 imr Aus Can NZ SouAfr



2022.0330 progress on 1915-19 

1915-19 should have 15 good-sized observations with full imr data ... 
Cities + larger places: 15
Metrops + larger places:  15
# NEXT n=15 : NYCxB Brkln Phila MassUrb CTurb othNEurb othNYurb othPAurb MIurb MNurb PArur NYrur MIrur MNrur NewEngRur  


12 (4 cities, 4 state-urban, 4 state-rural) + otherNewEngRur + othNewEngUrb + midWestUrban(ex-Detroit)
 not sure about Boston (too small?) and Pittsburgh (too small -- maybe break out other western PA cities? maybe group with Buffalo?)

have for sure 12 large places: NYCexBrkl, Brooklyn, Phila, Detroit, urbanMass(ex-Boston), urbanNY(ex-NYC), urbanPA(exPhil,Pittsb), urbanCT, ruralPA, rurNY, rurMI, rurMN.  (Rural PA could split up to add up to 3 obs)
Maybe Boston big enough, with u5white pop of 69K ; or fold it into MassUrban?
Certainly pool non-Mass NewEngland rural and nonMass,nonCT NewEngland urbam
Probably pool MnnStP with MnnUrb and MIurbanNonDetroit (13.7K+3.9K+16.8K)   
   Not sure what to do with DC (small).



CA is not a big part of our story, so useful to use for thinking about pooling to reduce binomial varation in CSR that will create attentuation bias in estimating the effect of q on CSR ... CA has 84k births in 1930, 49K are urban, 

NY  brooklyn 1930 214k

so with u5=100k, 1 std dev is 0.158% or less than 0.16%  ... our modelling says effect of q on lnCSR is mu*q where mu is excess male morality (relative to female). If we have mu=0.20 (small), then 0.16% change is caused by an IMR change of 0.8%-point or 8 per thousand (such as 100 to 92).  In our US panel, we are playing with IMRs in the range of 50 to 120, but most of the data are in the 50 to 90 range? 

Can we go with 60k as the threshold -- 1 std is then 0.204% (like an 11-point IMR change?). Maybe we can try it with different minimum sizes?


2022.0329 look at random variation in SR5 (as binomial) in relation to the sort of variation that life-tables predict -- say we have IMRs of 60  90  120   then what are the predicted values of SR5?   The we pick a minimum SR5 value so that teh random variation in SR is (say) only 10% as large as the systematic variation ...   with n=100k 1 std dev is .158%  which would push the SR5 0.67 towards female?


wondering how to decide whether to combine LA & SanFran -- *a priori* if both small, then combine. 1930's u5 populations LA 79K  SanFr 32K   -- maybe the answer is to set a higher limit, like pop of 1 mill?



2022.0328  for 1915-19 clean set of eIMR (5yr avg) for 25 places (rur/urb/metrop by state)  -- may want to collapse (aggregate) the smallest two ... thousand Births are 5.8 11.1 20.1 23.4 24.2 27.0 31.8  ... (5 yrs of that should give 4.5x those) ... probably

noon: Finished data entry for US states (urb, rural, some big cities) for 1925-30 and 1915-20 and 1905-10. Turning now to R scripts to create various RDS files with IMR u1d 

2022.0327 noting that black SB seem high -- maybe also SRB fem-tilted?
  looking for Brooklyn 1925-28  -- have u1deaths but not births; so can break out Brooklyn for u1d/SR5 but not for IMR

2022.0326  regress SR on IMR and on infDeath/u5pop -- which one wins?

2022.0324 compiling rural/urban by state 1915-1920 and 1925-30; Next will do 1905-1910  and 1896-1900

2022.0321  127-      
2020.0320  Consider using deaths per U5 pop instead of the IMR -- if we think births data are wrong ...     
CA 1930 can infer white/nonwhite -- but maybe treat it like AZ and go with "all" not with "white"?      
Blanks to fill in for births:  AL 1925, 1926     

2020.0319 for white urb/rur IMR by state, BSBRA T1 1917 1919   but what about 1920?  Tab II has urb/rur all
    
2022.0318  rural white births by state is BSBRA, maybe MS has u1 deaths rural?  -- nope, not 1916
2022.0316 
 RI ?
added 1930 LA Al
wondering if we can get DRA info not in BRA data?    GET LA cities at least 1918 ... etc  And can extend BRA using DRA if missing just a year or two 
Fill in LA 1926 via deaths -- best guess 1926 births same as 1927, so avgIMR 60.4 (w/o 1926 60.7)
LA u1 deaths 1926 from MS -- if births = min for 1927-30 eIMR 61.8 if avg 61.4  if max (1927 value), 60.4;  105% seems large annual swing, so look at that 1927*1.05 eIMR 59.8   1927/1.05  61.05 
AL  59.8 to 60.9 via 5% births swing ... use 1927 get 60.3  (w/o 1926 60.9)  ALl about same





2022.0314 for 1906-1910 IMR (infant deaths), 1906-09 offers only cities > 100K, which I have entered (or just mostly?)

2022.0314 thinking to get avg InfDeath for large pops of DRA, such as Chicago ... 1910 deaths are 3.8% above the 1906-10 mean;
MS1909 does not give totals for urb/rur in DRA states. It gives 1906-1909 u1 white deaths by sex, and 1906 is 104% of 1909; assuming 2% pop growth, the 1906 IMR would be 113% of 1909 -- still similar in context of our precision. So we can focus on geographic dimensions?

2022.0311
 right now SRcenDRA has URB10500 and URB500P -- the latter includes places like Cleveland and Pittsburgh ... probably want those to be added to URB10500 ... maybe just make the cutoff 
  via CITYPOP .. Chi 21852 NYC 47668 Phil 15490    -- cutoff at 15000
 
 separates urban(over 500K) from urban(10k to 500k)  

metros are Brooklyn 180K,  NYCexBrk 320K, Philly 147K, Chicago 223K ... then we drop down to Boston 63K, Clevel 62K, StLouis 58K, Pittsburgh 56K,   Baltimore 46K


1910 geography -- NYC pop breaks into Brooklyn (KingsCo 470) NYCo (Manh&Bronx 610) Queens (tiny 810)  StatenIls (tiny 850 Richmond Co); infant-deaths (IDth) are available by borough.  Ji splits NYC into Brooklyn (CITYj=4611) and rest-of-NYC (CITYj=4614) CITY=4610
 
categories rur10 rural (pop<10k) urb105 (pops 10k-500k) urb500p (cities over 1/2 )
 
Cleveland deaths not avail by race -- hope that the smaller metros are non-informative (relative to Reg cities generally), so we can simply dump Cleveland into OHIO registration cities. Otherwise, do rural-white urb10-50 all Cleve alll ..... 
 
 
2022.0310 Ji assembling 1910 data:  e.g  Mass into 3 parts: rural, Boston, NonBostonUrban
 MS1910 says rural has cities <10,000     But census1910 adopts 2,500 or more   ... so I would need to pull data for places of 2.5-10K   Distribution by broad age periods of the population in places having from 10,000 to 25,000 inhabitants: 1910 . . . . • . . . . . . . 489
   Could use 1910 MS data with PUMS --- 
  




2022.0305 Ji confirms the appendix accurately describes the years of the SR5 data (and that the IMR years are in the subheadings, such as  Australia (1876–1971))

2022.0304 drop HMD data for Eng&Wales in favor of Mitchell & ONS (same numbers in pop, but )

2022,0303  Discover England's quinquennial 1901-1971 is solid data (ONS), but HMD uses other stuff for 1916, 1936,1941,1946 (wartime mortality interests them). Appendix now reflects my preferred appraoch ... .

2022.0302 
For final version: add US 1940-1970 and drop Mass 1860 (Haines says 1860 is start of good IMR)



REFS: spacing between items.
REFS: If no author is identified for a source, begin the first entry with the title of the work. Alphabetize by the first word in the title other than “A(n)” or “The.”

2022.0228  
USA u5 pops decennially 1940-1970 from 1980 census. HMD data is weird to describe/cite -- no need!
-- even the "input" data is highly manipulated ... We just need 1940, 1950, 1960, 1970 ... 1980 is good.

Spain -- use HMD DATA not HMD raw -- that stuff is crap.  And use HMD-data for IMR, start IMR 1930 because of false-stillbirth issue (corrections made 1930 onward). Or drop Spain for missing girls?



https://jrmcirwin.github.io/sr1/US-BW.pdf  has typo      (HSUS Series Ab923,921; CDC-NCHS, Health, US, 2003, Table 19, p. 21) PAGE 121 not p21
       
       
looking at Spain -- data a mess, insomuch as HMD values are much different from census
HMD's 1920    251479.74       269065.69       520545.43
input 1920    218090          224156  RefCode 29 1920 census 
INE data has m0 Jul1 1981 296547  Jan1 293066 https://www.ine.es/jaxiT3/Datos.htm?t=31304
HMD-Js   has m0 1981 302091 ref code 23   
code 23 is 23  Source  Instituto Nacional de Estadística (INE). (1985). Censo de la Población de 1981: Resultados nacionales, Characteristicas de la Poblacion. Tomo I, Volumen I. Madrid: INE. Comments
(Census) Census counts 1981. De jure population as of 1 Mar 1991
      
Scotland 1921 u5 ref code 14  single years code 12
Ji's u5.rds & imr.rds updated. IMR unchanged.  NZ Ji adds u5pops 1867 1874 1926 (their USE flags were blank)        set USE=0 for 1948 non-Maori (overlap with 1951), but it was below the row-range of makeRDS.R;
NLD 1869 or 1870?  -- 1870 is *a priori* more reliable via NLDcom.pdf
Official population estimates date back to the beginning of the 1870s. During the period 1870-1930, these data were published together with the outcomes of the censuses or in the publications of the Dutch life tables (Tabeau, van Poppel, & Willekens, 1994)
