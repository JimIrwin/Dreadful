---
title: "SSMM-Log : Captain's Log for the SSMM/SR1 Project "
author: "jri & jrm"
...
Note: JIH Paper validation portion moved to new file, in EconHist (Js&Ji dropbox folder)

## highlights     
2020.0120 Race issue: Nigeria blacks with SRB 105.7 (n=864k) Ayeni [1975 Annals of Human Biology](https://www.dropbox.com/s/o28ir3y05i5r33d/Ayeni1975AnnHuBio?dl=0) 

## To do

Romaniuk 1967 in Brass, CoaleAJ, et al. "The Demography of the Democratic Republic of the Congo" Ch 6 of Brass, CoaleAJ, et al. *Demography of Tropical Africa*  p278 SRB 97.8 58K births  0.978 implies 95 % confidence limits 0.96 to 1.005
   no evidence for the Congo that female children are preferred to male children    ... the low SRB is consistent with a low SR in the age groups 0 to 1, 1 to 4, and 5 to 9 years, reported in all districts.    ... To a small extent, the deviation of the observed sex ratio from the expected one (1.03 fo 1.06) can be explained by the undercount of the children who have died shortly after their birth.  ... reported death rate under age 1 is only 104 per thousand live births, while the estimated infant death rate amounts to 164.  It is very likely that most (perhaps 80 or even 90 percent) of those omitted deaths are children born during the last year,

Low Gestational Weight Gain Skews
Human Sex Ratios towards Females
Kristen J. Navara*

Chacon-Puignau & JaffeK (2019 SocBio) Pro our view, but what is magnitude?    

CHECK ON     
[Some problems related to the collection of demographic data in the population censuses taken in Latin America during the 1980s](https://pubmed.ncbi.nlm.nih.gov/12314803/)
Arretx C, Chackiel J.     
Swende (2011 IntJBioMedRes dL)	Term birth weight and sex ratio of offspring of a nigerian obstetric population     

Onyiriuka & Ikeanyi	Sex Ratio at Birth: A Retrospective Audit of the Birth Records of a Nigerian Hospital     


## Log 2020.01

2020.0121 Start compiling race-related SRB in ssmLit  
...
Important discussion   1965-1972 SW Nigeria, Yorubas.    SRB 105.7 in over 800k births.   
