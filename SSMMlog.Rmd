...
### current log
<p>2021.0426 
<br><p>Possible revisions: Part 1 plots on a 1850 to 2000 time-scale (x-axis); IMR plots with Y axis range 0 to 300 (possibly LN -- constant slope is constant rate of decline) </p>
<p>suggested wording for outline:
<br> * There was a veritable collapse in the infant mortality rate (IMR) in the USA from the 19th century to the later 20th century -- from IMR values on the order of 10 to 20 percent or more, to values under 1 percent by the 1990s. 
