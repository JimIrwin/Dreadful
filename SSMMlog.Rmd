...
2021.1018 Jim finds Italian regional data. FOllowing up on Sardninia paper lead (and WoodsR) suggesting registration problems South vs North -- so maybe North IMR:SR looks sensible and South's looks silly. WOuld that be a basis for dumping Italy's data from our mix?  We are trying to include data that is deemed (and we deem) to be reliable ...
