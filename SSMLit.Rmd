...
DHS surveys, 3 subsets: eastern/southern Africa Bantu 1.010; various 1.035 ; subset with higher 1.070 Nigeria and Ethiopia 
<br>
...
**Pros** Arguing SRB **is** reduced by maternal misery (malnutrition, stress, other): Chacon-Puignau & JaffeK (2019 Soc Bio) Venezuela;
Kanninen & Karhula (2016 PloS one) GOOFBALL OECD macroecon SRB up pcInc; MathewsF, JohnsonPJ, Neil (2008 PRSCL); Andersson & Bergström (1998 Hu Bio);
...
Navarra (2014 PLoS One). Less gestational weight gain lowers SRB.  Seems like very extreme results, Figure 1 plots %male vs weight gain   0:0.484  80:0.54 that is 94 to 117  -- the 117 seems unlikely?
