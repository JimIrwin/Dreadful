...
Yasuba  Birth rates of the white population in the United States, 1800-1860 (dL inet archive).  

index/underenumeration of children 19, 23, 26, 29-30, 34-35, 70, 97, 142, 180; NY births 123
...
p26 In estimating the number of births, the number of children under 5 given by, or estimated from, a census was first increased to allow for underenumeration.8 <n8 Grabill et al. refers to 1940 on; see below>  SO: Yasuba assumes same 5% underenumeration of u5
...
Yasuba pp73-101 -- WASTE OF time for our project.  Ch 3 Mortality (his issue is extent to which birth-ratio patterns are from mortality (patterns are downward time-trend and regional differentials).     
...
Jim *cannot find that point in the 1850 Compendium* (also not found in [Report of the Superintendent](https://www2.census.gov/library/publications/decennial/1850/1850d/1850d-05.pdf))      
  random NY via surname Johnson NY-Kings i52-i60     
  2 ] 2 1 ] 1 ] 1 ] 2 1 1 2/12 ] 1 ] 8/12 1 1 ] 1 1 1 8/12 ] 2 2 [60]
